...
// Source: github.com/grayjunzi/backend-master-class-golang/db/sqlc (interfaces: Store)
...
// CreateTrasnfer mocks base method.
func (m *MockStore) CreateTrasnfer(arg0 context.Context, arg1 db.CreateTrasnferParams) (db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTrasnfer", arg0, arg1)
	ret0, _ := ret[0].(db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateTrasnfer indicates an expected call of CreateTrasnfer.
func (mr *MockStoreMockRecorder) CreateTrasnfer(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateTrasnfer", reflect.TypeOf((*MockStore)(nil).CreateTrasnfer), arg0, arg1)
}
